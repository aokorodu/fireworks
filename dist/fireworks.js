...
class Firework {
  ...
  initProps(x, y, delay) {
    this.startPosition = new _PVector__WEBPACK_IMPORTED_MODULE_0__["PVector"](x, y);
    this.location = new _PVector__WEBPACK_IMPORTED_MODULE_0__["PVector"](x, y);
    this.accel = new _PVector__WEBPACK_IMPORTED_MODULE_0__["PVector"](0, 0.2);

    this.velocity = new _PVector__WEBPACK_IMPORTED_MODULE_0__["PVector"](this.xvelocity(), this.yvelocity());
  ...
  reset() {
    ...
    this.velocity = new _PVector__WEBPACK_IMPORTED_MODULE_0__["PVector"](
      Math.random() * 20 - 10,
      Math.random() * 20 - 10
    );
  }
  ...
  update() {
    ...
    if (this.lifeSpan < this.defaultLifeSpan) {
      ...
      this.linePoints.unshift(new _PVector__WEBPACK_IMPORTED_MODULE_0__["PVector"](this.location.x, this.location.y));
    ...
    if (this.lifeSpan <= 0 || this.velocity.y > 2) {
      ...
      this.shape.visible = false;
      this.linePoints = [];
      gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(this.line, 1, { alpha: 0 });
    }
  }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Spark", function() { return Spark; });
/* harmony import */ var _PVector__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PVector */ "./src/PVector.js");
...
class Spark {
  ...
  initialize(x, y, maxX, maxY, stage) {
    ...
    this.startPosition = new _PVector__WEBPACK_IMPORTED_MODULE_0__["PVector"](x, y);
    this.location = new _PVector__WEBPACK_IMPORTED_MODULE_0__["PVector"](x, y);
    this.accel = new _PVector__WEBPACK_IMPORTED_MODULE_0__["PVector"](0, 0.1);
...
/* harmony import */ var _Spark__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Spark */ "./src/Spark.js");
/* harmony import */ var _Firework__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Firework */ "./src/Firework.js");
...
class App {
  ...
  buildSparks() {
    ...
    for (let i = 0; i < this.totalSparks; i++) {
      const spark = new _Spark__WEBPACK_IMPORTED_MODULE_1__["Spark"]();
  ...
  buildFireworks() {
    ...
    for (let i = 0; i < this.totalFireworks; i++) {
      const fw = new _Firework__WEBPACK_IMPORTED_MODULE_2__["Firework"]();
      const delay = i * 60;
